...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "495555f3-3bbc-446b-9a14-6fc0fcfd5189",
...
const _W56p7hHKc8KKsn1BCP3zW8qAjDRtuXlzUnJ7BO7mWQ = (function(nitro) {
...
const plugins = [
  _W56p7hHKc8KKsn1BCP3zW8qAjDRtuXlzUnJ7BO7mWQ
];
...
const _WzafbW = defineCachedEventHandler(async (event) => {
...
const _lazy_byYp0f = () => import('../routes/api/members.mjs');
const _lazy_HEmBAE = () => import('../routes/api/roster.mjs');
const _lazy_VnlwHi = () => import('../routes/api/teams.mjs');
const _lazy_GUO437 = () => import('../routes/api/teams/_id_.mjs');
const _lazy_ATNbCx = () => import('../routes/api/teams/_id/players.mjs');
const _lazy_SvRjmi = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/members', handler: _lazy_byYp0f, lazy: true, middleware: false, method: undefined },
  { route: '/api/roster', handler: _lazy_HEmBAE, lazy: true, middleware: false, method: undefined },
  { route: '/api/teams', handler: _lazy_VnlwHi, lazy: true, middleware: false, method: undefined },
  { route: '/api/teams/:id', handler: _lazy_GUO437, lazy: true, middleware: false, method: undefined },
  { route: '/api/teams/:id/players', handler: _lazy_ATNbCx, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_SvRjmi, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _WzafbW, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SvRjmi, lazy: true, middleware: false, method: undefined }
];
...
export { getQuery as a, getRouterParam as b, createError as c, buildAssetsURL as d, eventHandler as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, defineRenderHandler as k, getQuery$2 as l, createError$2 as m, normalizeCookieHeader as n, destr$1 as o, publicAssetsURL as p, getRouteRules as q, useNitroApp as u };
